...
btnScrollTo.addEventListener('click', function(e){
  ...
  console.log('height/width od viewport', document.documentElement.clientHeight, document.documentElement.clientWidth);
...
tabsContainer.addEventListener('click', function(e){
  ...
  //remove the tab and content area that is not active
